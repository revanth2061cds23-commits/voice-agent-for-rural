...
logger.info("Rita Devanagari Experiment — Sarvam-30B LLM + codemix STT + Devanagari Hindi + 0.07s delay")
...
Ek buri error 10 achi interactions ka trust tod deti hai. Rita ko HAMESHA pata hona chahiye kya karna hai jab kuch galat ho.
...
- Agar bilkul samajh nahi aa raha: "जी... ज़रा Hindi mein bata dijiye toh zyada achi tarah madad kar paaungi"
